...
import com.moviedb.databinding.FragmentUpcomingMovieListBinding
 ...
 * Use the [UpcomingMovieListFragment.newInstance] factory method to
...
class UpcomingMovieListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            lifecycleOwner = this@UpcomingMovieListFragment
            viewModel = viewModel
    ...
    companion object {
         ...
         * @return A new instance of fragment UpcomingMovieListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UpcomingMovieListFragment().apply {
